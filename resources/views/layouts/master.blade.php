...
<main class="app-content">
    ...
    <x-master.errors></x-master.errors>
...
{{-- <script type="text/javascript" src="{{ asset('admin_assets/js/plugins/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script> --}}
