<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" style="font-family: 'Cairo', 'sans-serif';" href="">رحال</a>
    ...
    <ul class="app-nav">
        ...
        {{-- <li class="dropdown" id="notifications">
            ...
            <ul class="app-notification dropdown-menu dropdown-menu-right">
                ...
                <li class="app-notification__footer"><a href="#">كل الاشعارات</a></li>
            </ul>
        </li> --}}
        ...
        <li class="dropdown">
            <a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu">
                <i class="fa fa-language fa-lg"></i> {{-- {{ Config::get('languages')[App::getLocale()] }} --}}
            </a>
