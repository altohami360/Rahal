            ...
            <div class="tile shadow">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>{{ $dailyTrip->pickup_address }}</p>
                        <h5>@lang('trips.dropoff') : </h5>
                        <p>{{ $dailyTrip->dropoff_address }}</p>
                        <h5>@lang('drivers.driver') : </h5>
                        <p>{{ $dailyTrip->driver->name ?? '------------' }}</p>
                        <h5>@lang('customers.customer') : </h5>
                        <p>{{ $dailyTrip->customer->name }}</p>
                        <h5>@lang('trips.cost')</h5>
                        <p>{{ $dailyTrip->cost }} <sub>SAR</sub> </p>
                        <h5>@lang('trips.distance')</h5>
                        <p>{{ $dailyTrip->distance }} <sub>KM</sub> </p>
