                ...
                <form method="post" action="{{ route('drivers.update', $driver) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name')is-invalid @enderror" value="{{ old('name' , $driver->name) }}" >
                        ...
                        {{--id--}}
                        <div class="form-group col-md-6">
                            <label>@lang('drivers.personal_id') <span class="text-danger">*</span></label>
                            <input type="text" name="personal_ID" class="form-control @error('personal_ID')is-invalid @enderror" value="{{ old('personal_ID' , $driver->personal_ID) }}" >
                            <div class="form-control-feedback text-danger">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="phone" name="phone" class="form-control @error('phone')is-invalid @enderror" value="{{ old('phone' , $driver->phone) }}" >
                            <div class="form-control-feedback text-danger">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="gender_id" class="form-control @error('gender_id')is-invalid @enderror" >
                                ...
                                @foreach ($genders as $gender)
                                    <option value="{{ $gender->id }}" @selected($gender->id == old('gender_id' , $driver->gender_id))>Male</option>
                                @endforeach
                            </select>
                            <div class="form-control-feedback text-danger">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control @error('birthday')is-invalid @enderror" name="birthday" id="demoDate" type="date" value="{{ old('birthday' , $driver->birthday) }}">
                            <div class="form-control-feedback text-danger">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="nationality_id" class="form-control  @error('nationality_id')is-invalid @enderror" >
                                ...
                                @foreach ($nationalities as $nationality)
                                    <option value="{{ $nationality->id }}" @selected($nationality->id == old('nationality_id' , $driver->nationality_id))>{{ $nationality->nationality }}</option>
                                @endforeach
                            </select>
                            <div class="form-control-feedback text-danger">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>@lang('drivers.identification_card_image')</label>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="service_id" class="form-control @error('service_id')is-invalid @enderror" >
                                ...
                                @foreach ($services as $service)
                                    <option value="{{ $service->id }}" @selected($service->id == old('service_id' , $driver->service_id))>{{ $service->service }}</option>
                                @endforeach
                            </select>
                            <div class="form-control-feedback text-danger">
                    ...
                    <div class="row">
                        {{--car_type_id--}}
                        <div class="form-group col-md-6">
                            <label>@lang('drivers.car_type') <span class="text-danger">*</span></label>
                            <select name="car_type_id" class="form-control @error('car_type_id')is-invalid @enderror" >
                                <option value="">@lang('site.choose') @lang('drivers.service')</option>
                                @foreach ($cars as $car)
                                    <option value="{{ $car->id }}" @selected($car->id == old('car_type_id' , $driver_car->car_type_id))>{{ $car->type }}</option>
                                @endforeach
                            </select>
                            <div class="form-control-feedback text-danger">
                    ...
                    <div class="row">
                        {{--model--}}
                        <div class="form-group col-md-6">
                            <label>@lang('site.choose') @lang('driver.model')</label>
                            <input type="text" name="model" class="form-control @error('model')is-invalid @enderror" value="{{ old('model' , $driver_car->model) }}">
                            <div class="form-control-feedback text-danger">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="plate_number" class="form-control @error('plate_number') is-invalid @enderror" value="{{ old('plate_number', $driver_car->plate_number) }}">
                            <div class="form-control-feedback text-danger">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="color_id" class="form-control  @error('color_id')is-invalid @enderror">
                                ...
                                @foreach ($colors as $color)
                                    <option value="{{ $color->id }}" @selected($color->id == old('color_id' , $driver_car->color_id))>{{ $color->name }}</option>
                                @endforeach
                            </select>
                            <div class="form-control-feedback text-danger">
