                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="table" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('services.starting_value')</th>
                                    <th>@lang('services.per_kilometer')</th>
                                    <th>@lang('services.per_minute')</th>
                                    <th>@lang('drivers.is-active')</th>
...
@push('scripts')
    ...
    <script>
        ...
        let servicesTable = $('#table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
            ...
            columns: [
                ...
                {data: 'service.' + $('html').attr('lang'), name: 'service'},
                {data: 'starting_value', name: 'starting_value'},
                {data: 'per_kilometer', name: 'per_kilometer'},
                {data: 'per_minute', name: 'per_minute'},
